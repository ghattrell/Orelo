...
class CallsControllerTest < ActionController::TestCase
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post :create, call: { create: @call.create, destroy: @call.destroy, room: @call.room, user1_id: @call.user1_id, user2_id: @call.user2_id }
    end
  ...
  test "should update call" do
    put :update, id: @call, call: { create: @call.create, destroy: @call.destroy, room: @call.room, user1_id: @call.user1_id, user2_id: @call.user2_id }
    assert_redirected_to call_path(assigns(:call))
  end
